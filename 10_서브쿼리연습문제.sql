...
*/
SELECT 
 e.employee_id,first_name ||' '||last_name AS FULL_NAME,
...
조건) 부서아이디 기준 오름차순 정렬
*/
SELECT d.department_id, d.manager_id, d.department_name, 
...
SELECT loc.location_id,loc.street_address,loc.city,c.country_id
,c.country_name
FROM locations loc
...
*/
    SELECT d.*,loc.street_address,loc.country_id,
    (
